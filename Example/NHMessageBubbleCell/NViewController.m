...
//
    ((NHSimpleTextBubble*)cell).shadowLayer.shadowOpacity = 1;
//    ((NHSimpleTextBubble*)cell).shadowLayer.shadowColor = [UIColor greenColor].CGColor;
//    ((NHSimpleTextBubble*)cell).shadowLayer.shadowRadius = 0;
